...
export function ActionButtons({ actions, className = '' }: ActionButtonsProps) {
  ...
  const getActiveVariantStyles = (variant: ActionButton['variant']) => {
    switch (variant) {
      case 'success':
        return 'disabled:bg-[#E6F9E6] disabled:text-[#006B03] bg-[#009543] text-white';
      case 'primary':
        return 'disabled:opacity-50 disabled:bg-blue-500 disabled:text-white bg-blue-500 text-white';
      case 'danger':
        return 'disabled:bg-[#FDE6E6] disabled:text-[#ED0000] bg-[#C50000] text-white';
      default:
        return 'disabled:opacity-50 disabled:bg-blue-500 disabled:text-white bg-blue-500 text-white';
    }
  };
