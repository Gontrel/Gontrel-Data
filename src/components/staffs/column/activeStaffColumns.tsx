...
import { StaffTableTypes } from "@/types";
import { formatDate } from "@/lib/utils";

export const createActiveStaffColumns = (
  ...
  {
    accessorKey: "role",
    header: () => <TableHeader iconName="personIcon2" title="Role" />,
    cell: ({ row }) => (
  ...
  {
    accessorKey: "restaurant.total",
    header: () => (
      <TableHeader iconName="restaurantIcon" title="Total restaurants" />
    ),
    cell: ({ row }) => (
      <div className="text-center text-[17px] font-medium">
