...
export const LivePostCard = ({
  ...
  return (
    <div className="flex flex-col rounded-2xl overflow-hidden border border-[#D2D4D5] bg-white max-w-[556px] mx-auto py-6 px-8 gap-y-4.5 mt-4">
      <GontrelPostView
      ...
      <div className="flex items-center text-sm text-gray-500">
        ...
        />
        <span>Uploaded by: {post?.admin?.name}</span>
