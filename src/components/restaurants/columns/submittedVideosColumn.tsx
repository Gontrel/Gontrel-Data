    ...
    cell: ({ row }) => {
      return (
        <div
          ...
          className="absolute top-0 bottom-0 left-0 right-0 flex items-center py-5 px-2.5 font-medium text-[#181D1F] max-w-60 w-full h-full overflow-hidden"
        >
